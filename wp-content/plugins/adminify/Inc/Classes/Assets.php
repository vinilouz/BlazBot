...
class Assets extends AdminSettingsModel
{
    ...
    public function jltwp_adminify_admin_scripts()
    {
        ...
        wp_register_style(
            'wp-adminify-admin',
            WP_ADMINIFY_ASSETS . 'css/wp-adminify.css',
            false,
            WP_ADMINIFY_VER
        );
        wp_register_style(
            'wp-adminify-default-ui',
            WP_ADMINIFY_ASSETS . 'css/wp-adminify-default-ui.css',
            false,
            WP_ADMINIFY_VER
        );
        wp_register_style(
            'wp-adminify-admin-bar',
            WP_ADMINIFY_ASSETS . 'css/admin-bar.css',
            false,
            WP_ADMINIFY_VER
        );
        wp_register_style(
            'wp-adminify-menu-editor',
            WP_ADMINIFY_ASSETS . 'css/adminify-menu-editor.css',
            false,
            WP_ADMINIFY_VER
        );
        wp_register_style(
            'wp-adminify-dark-mode',
            WP_ADMINIFY_ASSETS . 'css/dark-mode.css',
            false,
            WP_ADMINIFY_VER
        );
        wp_register_style(
            'wp-adminify-rtl',
            WP_ADMINIFY_ASSETS . 'css/adminify-rtl.css',
            false,
            WP_ADMINIFY_VER
        );
        wp_register_style(
            'wp-adminify-responsive',
            WP_ADMINIFY_ASSETS . 'css/adminify-responsive.css',
            false,
            WP_ADMINIFY_VER
        );
        wp_register_style(
            'wp-adminify-tokenize2',
            WP_ADMINIFY_ASSETS . 'vendors/tokenize/tokenize2.min.css',
            false,
            WP_ADMINIFY_VER
        );
        wp_register_style(
            'wp-adminify-animate',
            WP_ADMINIFY_ASSETS . 'vendors/animatecss/animate.css',
            false,
            WP_ADMINIFY_VER
        );
        ...
        wp_register_style(
            ...
            WP_ADMINIFY_ASSETS . 'fonts/simple-line-icons/css/simple-line-icons.css',
            false,
            WP_ADMINIFY_VER
        );
        wp_register_style(
            'wp-adminify-icomoon',
            WP_ADMINIFY_ASSETS . 'fonts/icomoon/style.css',
            false,
            WP_ADMINIFY_VER
        );
        wp_register_style(
            'wp-adminify-themify-icons',
            WP_ADMINIFY_ASSETS . 'fonts/themify-icons/themify-icons.css',
            false,
            WP_ADMINIFY_VER
        );
        //Register Scripts
        ...
        wp_register_script(
            ...
            WP_ADMINIFY_ASSETS . 'css/controls.css',
            null,
            WP_ADMINIFY_VER
        );
        ...
        wp_register_style(
            ...
            WP_ADMINIFY_ASSETS . 'vendors/adminify-icon-picker/css/style.css',
            false,
            WP_ADMINIFY_VER
        );
        wp_register_script(
        ...
        wp_register_script(
            ...
            WP_ADMINIFY_ASSETS . 'admin/js/vendor.js',
            [ 'wp-adminify-vue-manifest' ],
            WP_ADMINIFY_VER,
            true
        );
        ...
        wp_enqueue_style(
            ...
            WP_ADMINIFY_ASSETS . 'admin/css/wp-adminify--admin-columns.css',
            [ 'wp-adminify-themify-icons' ],
            WP_ADMINIFY_VER
        );
        wp_register_script(
            'wp-adminify-admin-columns',
            WP_ADMINIFY_ASSETS . 'admin/js/wp-adminify--admin-columns.js',
        ...
        wp_register_script(
            ...
            WP_ADMINIFY_ASSETS . 'admin/js/wp-adminify--page-speed.js',
            [ 'jquery', 'wp-adminify-vue-vendors' ],
            WP_ADMINIFY_VER,
            true
        );
        ...
        wp_register_script(
            'wp-adminify--folder',
            WP_ADMINIFY_ASSETS . 'admin/js/wp-adminify--folder.js',
            [
            'jquery',
            'jquery-ui-droppable',
            'jquery-ui-draggable',
    ...
    {
        //Styles
        wp_register_style( 'wp-adminify-vegas', WP_ADMINIFY_ASSETS . 'vendors/vegas/vegas.min.css' );
        //Scripts
        wp_register_script(
            'wp-adminify-vegas',
        ...
        wp_register_script(
            'wp-adminify-vidim',
            WP_ADMINIFY_ASSETS . 'vendors/vidim/vidim.min.js',
            [ 'jquery' ],
            WP_ADMINIFY_VER,
            true
        );
