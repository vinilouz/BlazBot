...
class Folders
{
    ...
    function manage_columns_head( $posts_columns )
    {
        ...
        if ( $this->is_module_active( $post_type ) ) {
            return [
                'adminify_move' => '<div class="adminify-move-multiple adminify-col" title="' . esc_attr__( 'Move selected items', 'adminify' ) . '"><span class="dashicons dashicons-move"></span><div class="adminify-items"></div></div>',
            ] + $posts_columns;
        }
