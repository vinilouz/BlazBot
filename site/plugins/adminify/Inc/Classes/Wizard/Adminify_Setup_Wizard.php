...
class Adminify_Setup_Wizard
{
    ...
    public function load_scripts()
    {
        ...
        wp_register_script(
            ...
            WP_ADMINIFY_ASSETS . 'admin/js/wp-adminify--setup-wizard.js',
    ...
    public function setup_step_menu()
    {
        ...
        ?>
                ...
                <tr class="active_menu_style" v-if="settings.menu_layout_settings.layout_type == 'horizontal'">
                    <th scope="row">
        ...
        ?></label>
                ...
                <tr class="active_menu_style" v-if="settings.menu_layout_settings.layout_type == 'vertical'">
                    <th scope="row">
                        <label for="site_name"><?php 
        ...
        ?></label>
                    ...
                    <td>
                        <div class="wp-adminify-sw-radio-group">
                            <input type="radio" id="active_menu_style_classic" value="classic" v-model="settings.menu_layout_settings.active_menu_style">
                            <label for="active_menu_style_classic"><?php 
        esc_html_e( 'Classic', 'adminify' );
        ?></label>

                            <input type="radio" id="active_menu_style_rounded" value="rounded" v-model="settings.menu_layout_settings.active_menu_style">
                            <label for="active_menu_style_rounded"><?php 
